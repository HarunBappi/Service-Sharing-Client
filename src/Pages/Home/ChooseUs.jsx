  ...
  return (
    <div data-aos="flip-down">
      ...
      <div className="w-4/6 mx-auto pt-5">
        <h1 className="text-3xl text-gray-800 dark:text-white" data-aos="fade-right">-WHY CHOOSE US</h1>
        <h3 className="text-2xl text-gray-500 mt-2" data-aos="fade-right">
          Because we care about your safety..
        </h3>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 md:w-10/12 md:mx-auto gap-5 py-5 px-2 md:px-0">
        <div className="grid grid-cols-2 gap-5 lg:gap-y-0" data-aos="fade-left">

...
export default function Register() {
  const {signInGoogle, handleRegister} = useContext(AuthContext)
      ...
      <div className="flex w-full max-w-sm mx-auto bg-white rounded-l-lg shadow-lg  lg:max-w-4xl ">
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-green-200 rounded-r-lg">
          ...
          <div className="mt-4 px-2 md:px-0">
            <button onClick={handleGoogleSignin} className="bg-white flex gap-8  items-center justify-center mx-auto p-3 rounded-lg  hover:bg-gray-100">
              <img className="w-8" src={google} alt="" />
              <p className="text-gray-600 font-semibold">Register With Google</p>
            </button>
          </div>
